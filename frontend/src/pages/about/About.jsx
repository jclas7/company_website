...
import Budiing from "../../assets/imageb2.jpg";
    ...
    <div className="container mx-auto px-4 py-32 max-w-7xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-24">
        {[
          ...
          <div
            key={index}
            className="bg-white rounded-xl shadow-lg p-10 text-center hover:shadow-2xl transition-all duration-300 border-gray-100"
          >
      ...
      <div className="mb-24 max-w-4xl mx-auto text-center">
        ...
        <p className="text-2xl leading-relaxed text-gray-600 font-light">
          "2030년까지 글로벌 도약을 위한 선도 혁신 기업을 나가고
          <br /> 더 나은 세상을 만들어가겠습니다."
        </p>
      </div>
      <div className="mb-24">
        ...
        <div className="space-y-12 max-w-5xl mx-auto">
          {[
            { year: "2026", event: "글로벌 시장 진출" },
            { year: "2025", event: "시리즈 B 투자 유치" },
