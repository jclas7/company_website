...
function AdminContacts(props) {
  ...
  useEffect(() => {
    const fetchContacts = async () => {
      try {
        const reponse = await axios.get("http://localhost:3000/api/contact", {
  ...
  return (
    <div className="p-4 mx-auto max-w-[1400px] bg-gradient-to-r from-green-100 to-green-50">
      ...
      <div className="mt-4 flex justify-center space-x-2 text-lg font-bold">
        <button
          className="px-3 py-1 rounded border diabled-opacity-50"
