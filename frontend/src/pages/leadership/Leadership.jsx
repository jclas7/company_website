...
import Human1 from "../../assets/ceo.png";
...
function Leadership(props) {
  ...
  return (
    <div className="containter max-w-7xl max-auto px-4 py-32">
      <div className="text-center mb-12">
        <h1 className="text-4xl lg:text-5xl font-bold text-gray-800 mb-4">
          임원진 소개
        </h1>
        <p className="text-xl text-gray-600">
          혁신과 성장 을 이끌어가는 선도 기업 의 리더쉽
        </p>
      </div>
      <div className="flex flex-col md:flex-row gap-12 mb-24 items-center">
        <div className="md:w-2/3">
          ...
          <div className="text-lg text-gray-600 space-y-6">
            ...
            <p className="font-semibold mt-8">JC Company 대표인사 인사</p>
          </div>
        </div>
        <div className="md:w-1/3">
          <div className="rounded-xl overflow-hidden shadow-lg">
            <img src={ceo} className="w-full aspect-[3/4] object-cover"></img>
            <div className="p-4 bg-white">
              <h3 className="text-xl font-bold text-gray-800">대표이사</h3>
              <p className="text-indigo-600">리더쉽 CEO</p>
            </div>
          </div>
        </div>
      </div>
      <div className="mb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {executives.map((value, index) => (
            <div
              key={index}
              className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transitio-shadow duration-300"
            >
